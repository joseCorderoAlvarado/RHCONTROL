...
GRANT SELECT, INSERT ON apo_pro_com_april_ten.APC_LOAN_DETAIL TO 'apoprocommobilelocalhost'@'localhost';
...
GRANT SELECT ON apo_pro_com_april_ten.APC_CLOSING_DAILY_DETAIL_FROM_USER_BY_CURDATE_VIEW_REPORT TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_STABLE_SMALL_BOX TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_CLOSING_DAY TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_MONEY_DAILY TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_PAYROLL TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_ADVANCE TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_EXPENSE_COMPANY TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_STABLE_GENERAL_BOX TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_LOAN TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_LOAN_TYPE TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_LOAN_DETAIL TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_LOAN_BY_USER TO 'apcreportdesktop'@'localhost';
GRANT SELECT ON apo_pro_com_april_ten.APC_OFFICE TO 'apcreportdesktop'@'localhost';
-- -------------------------------------------------------------------------------------
