...
GRANT SELECT, INSERT, UPDATE ON apo_pro_com_april_ten.APC_GASOLINE  TO 'apoprocommobile'@'%';
-- SELECT
...
GRANT SELECT ON apo_pro_com_april_ten.APC_USER_WEEK_REPORT_VIEW TO 'apoprocommobile'@'%';
-- ----------------------------------------------------------------------
